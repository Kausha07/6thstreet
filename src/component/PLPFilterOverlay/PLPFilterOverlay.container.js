...
import CategoryFilterOverlay from './PLPFilterOverlay.component';
...
export class PLPFilterOverlayContainer extends PureComponent {
    static propTypes = {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PLPFilterOverlayContainer));

...
class CreditCard extends PureComponent {
  ...
  haveUnvalidFields() {
    const { validatorMessage, numberFilled, expDateFilled, cvvFilled } =
      this.state;
  ...
  handleNumberChange = (e) => {
    const { setCreditCardData, reformatInputField, getCardLogo, isAmex } =
      this.props;
  ...
  handleExpDateChange = (e) => {
    const { setCreditCardData, expDateValidator, reformatInputField } =
      this.props;
    const { value } = e.target;
      ...
      <div block="CreditCard" elem="Card" dir="ltr">
        ...
        <div block="CreditCard" elem="Row">
          ...
          <input
            ...
            onPaste={this.handlePaste}
          />
          <div block="CreditCard" elem="CardLogo">

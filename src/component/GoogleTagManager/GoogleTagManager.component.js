...
import EddDateOnOrderEvent from "./events/EddDateOnOrder.event";
...
export const EVENT_EDD_DATE_AT_PLACE_ORDER = "eddDateAtPlaceOrder";
...
class GoogleTagManager extends PureComponent {
  ...
  static eventList = {
    ...
    [EVENT_EDD_DATE_AT_PLACE_ORDER]:EddDateOnOrderEvent,

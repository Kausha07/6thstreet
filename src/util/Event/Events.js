...
export const EVENT_MOE_TOP_NAV_HOME = "top_nav_home";
...
export const EVENT_MOE_WHATSAPP_SHARE = "whatsapp_share_icon";
export const EVENT_MOE_MAIL_SHARE = "email_share_icon";
...
export const EVENT_MOE_TABBY_LEARN_MORE_CLICK = "tabby_learn_more_click";
export const EVENT_MOE_BRAND_SEARCH_FILTER = "brand_search_filter";
export const EVENT_MOE_BRAND_SEARCH_FOCUS = "brand_search_focus";
export const EVENT_MOE_COLOR_SEARCH_FILTER = "color_search_filter";
export const EVENT_MOE_COLOR_SEARCH_FOCUS = "color_search_focus";
export const EVENT_MOE_SIZES_SEARCH_FILTER = "sizes_search_filter";
export const EVENT_MOE_SIZES_SEARCH_FOCUS = "sizes_search_focus";
export const EVENT_MOE_CATEGORIES_WITHOUT_PATH_SEARCH_FILTER =
  "categories_without_path_search_filter";
export const EVENT_MOE_CATEGORIES_WITHOUT_PATH_SEARCH_FOCUS =
  "categories_without_path_search_focus";
export const EVENT_MOE_DISCOUNT_FILTER_CLICK = "discount_filter_click";
export const EVENT_MOE_PLP_SHOW_FILTER_RESULTS_CLICK =
  "plp_show_filter_results_click";
export const EVENT_MOE_PRICE_FILTER_CLICK = "price_filter_click";
export const EVENT_MOE_PLP_SORT = "plp_sort";
export const EVENT_MOE_SORT_BY_DISCOUNT = "sort_by_discount";
export const EVENT_MOE_SORT_BY_LATEST = "sort_by_latest";
export const EVENT_MOE_SORT_BY_PRICE_HIGH = "sort_by_price_high";
...
export const EVENT_MOE_SHIPPING_INFO_CLICK = "shipping_info_click";
export const EVENT_MOE_RETURN_INFO_CLICK = "return_info_click";
export const EVENT_MOE_FEEDBACK_CLICK = "feedback_click";
export const EVENT_MOE_FEEDBACK_FORM_SUBMIT = "feedback_form_submit";
export const EVENT_MOE_PRIVACY_POLICY_CLICK = "privacy_policy_click";
export const EVENT_MOE_DISCLAIMER_CLICK = "disclaimer_click";
export const EVENT_MOE_CONSUMER_RIGHTS_CLICK = "consumer_rights_click";
export const EVENT_MOE_ABOUT6S_CLICK = "about6s_click";
...
export const EVENT_GTM_GO_TO_SEARCH = "go_to_search"; // 1 
export const EVENT_CLICK_SEARCH_QUERY_SUGGESSTION_CLICK = "search_query_suggestion_click";
export const EVENT_CLICK_SEARCH_WISH_LIST_CLICK = "search_wish_list_click"; //5
...
export const EVENT_CLICK_RECENT_SEARCHES_CLICK = "recent_searches_click"; //2
...
export const EVENT_CLICK_TOP_SEARCHES_CLICK = "top_searches_click"; //3
export const EVENT_CLICK_RECOMMENDATION_CLICK = "recommendation_clicked"; //4
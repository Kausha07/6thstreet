...
export const EVENT_GTM_EDD_VISIBILITY_ON_PDP = "gtm_edd_visibility_on_pdp";
export const EVENT_GTM_EDD_VISIBILITY_ON_MY_ORDER = "gtm_edd_visibility_on_my_order";
export const EVENT_GTM_EDD_DATE_AT_PLACE_ORDER = "gtm_edd_date_at_place_order";
